            ...
            <div class="form_section d-flex justify-content-center">
              <div class="inner_container">
                <div class="header_form">
                  <div class="login_title text-customblack text-center mb-0">Add New Password </div>
                </div>
                <div class="form__row">
                  <form @submit.prevent="login">
                    ...
                    <div class="row justify-content-center">
                      ...
                      <div class="col-sm-12 col-md-12 col-lg-10 position-relative">
                        <label class="d-flex align-items-center text-customblack" for="email"
                          > New Password<sup class="text-maximumred mendratory_sign">*</sup></label
                        >
                        <input
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-10 position-relative">
                      <label class="d-flex align-items-center text-customblack" for="email"
                        > Confirm  Password<sup class="text-maximumred mendratory_sign">*</sup></label
                      >
                      <input
                        class="input w-100 bg-white"
                        autocomplete="off"
    ...
    .emailer_logo {
      ...
      justify-content: center;
        ...
        img {
          ...
          position: relative;
      right: 28px;
      top: 45px; /* Maintain aspect ratio */
        }
    }
  }
