  ...
  <div class="home_page bg-sidegrey pb-5 h-100">
    <div class="container-fluid p-0">
      <div class="d-flex justify-content-between w-100 vh-100">
        <Sidebar />
        <div
          :class="`${store.isSidebarExpanded ? 'shrink_screen' : ''}`"
          class="right_panel"
        >
          <Header />
                  ...
                  <div class="breadcrumbs">
                    <CBreadcrumb style="--cui-breadcrumb-divider: '/'">
                      <CBreadcrumbItem href="/"
                        ><img
                          src="../assets/image/home_icon (1).svg"
                          alt="configuration"
                      /></CBreadcrumbItem>
                      <CBreadcrumbItem href="/createdomain"
                        >Sender Identity</CBreadcrumbItem
                      >
                    ...
                    <div class="tab-content domain_content mb-3">
                      ...
                      <div class="d-inline-block mx-5">
                        <NuxtLink to="/sendercreate">
                          <button class="addsender_btn bg-aliceblue text-white">
                            + ADD
                          </button>
                        </NuxtLink>
      ...
      arr: [
        {
          ...
          subtext:
            'Sending domains are used to indicate who an email is from via the "From" header. DNS records can be configured for a sending domain, which allows recipient mail servers to authenticate messages sent from Messagecloud.ai.',
        },
        {
