<template>
    <CModal class="sender_modal">
      ...
      <div class="row header p-0 bg-sidegrey">
        <div class="col-lg-6 container p-5">
          <CModalBody>
       

                <h5 class="text-customblack mb-4 ">Success ! Your Contact has been added<img src="../assets/image/pass.svg" class="ms-3" alt=""></h5>
